...
# sortPatches.sh - sorts the patches (.patch files) received from contributors into their respective folders depending on their groups and packages they belong to.
#
